		  ...
		  <div style="padding-top: 70px;">
		    ...
		    <div class="container">
			  ...
			  <table class="table table-striped">
				...
				$cse_sql = "SELECT * FROM quiz WHERE department = 'CSE' AND year = '1st' AND 
		  ...
		  <div style="padding-top: 70px;">
		    ...
		    <div class="container">
			  ...
			  <table class="table table-striped">
				...
				$cse_sql = "SELECT * FROM quiz WHERE department = 'CSE' AND year = '2nd' AND 
									semester = '1st' AND section = 'A' AND
								   date >= CURDATE() 
								   ORDER BY date";
		  ...
		  <div style="padding-top: 70px;">
		    ...
		    <div class="container">
			  ...
			  <table class="table table-striped">
				...
				$cse_sql = "SELECT * FROM quiz WHERE department = 'CSE' AND year = '3rd' AND 
									semester = '1st' AND section = 'A' AND
								   date >= CURDATE() 
								   ORDER BY date";
		  ...
		  <div style="padding-top: 70px;">
		    ...
		    <div class="container">
			  ...
			  <table class="table table-striped">
				...
				$cse_sql = "SELECT * FROM quiz WHERE department = 'CSE' AND year = '4th' AND 
									semester = '1st' AND section = 'A' AND
								   date >= CURDATE() 
								   ORDER BY date";
