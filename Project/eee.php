		  ...
		  <div style="padding-top: 70px;">
		    ...
		    <div class="container">
			  ...
			  <table class="table table-striped">
				...
				$cse_sql = "SELECT * FROM quiz WHERE department = 'EEE' AND year = '1st' AND 
		  ...
		  <div style="padding-top: 70px;">
		    ...
		    <div class="container">
			  ...
			  <table class="table table-striped">
				...
				$cse_sql = "SELECT * FROM quiz WHERE department = 'EEE' AND year = '2nd' AND 
									semester = '1st' AND section = 'A' AND
								   date >= CURDATE() ORDER BY date";
		  ...
		  <div style="padding-top: 70px;">
		    ...
		    <div class="container">
			  ...
			  <table class="table table-striped">
				...
				$cse_sql = "SELECT * FROM quiz WHERE department = 'EEE' AND year = '3rd' AND 
									semester = '1st' AND section = 'A' AND
								   date >= CURDATE() ORDER BY date";
		  ...
		  <div style="padding-top: 70px;">
		    ...
		    <div class="container">
			  ...
			  <table class="table table-striped">
				...
				$cse_sql = "SELECT * FROM quiz WHERE department = 'EEE' AND year = '4th' AND 
									semester = '1st' AND section = 'A' AND
								   date >= CURDATE() ORDER BY date";
